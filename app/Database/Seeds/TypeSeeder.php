...
class TypeSeeder extends Seeder
{
    public function run()
    {
        $data = [
            ...
            ['name' => 'Manga', 'slug' => 'manga', 'id_type_parent' => 2],
            ['name' => 'Shonen', 'slug' => 'shonen', 'id_type_parent' => 4],
            ['name' => 'Seinen', 'slug' => 'seinen', 'id_type_parent' => 4],
            ...
            ['name' => 'Comics', 'slug' => 'comics', 'id_type_parent' => 2],
            ['name' => 'Artbook', 'slug' => 'artbook', 'id_type_parent' => 2],
            ['name' => 'Roman', 'slug' => 'roman', 'id_type_parent' => 2],
