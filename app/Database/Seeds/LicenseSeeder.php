...
class LicenseSeeder extends Seeder
{
    public function run()
    {
        $data = [
            ...
            ['name' => 'Iron Man', 'slug' => 'iron-man', 'id_license_parent' => 4],
            ['name' => 'Spider-Man', 'slug' => 'spider-man', 'id_license_parent' => 4],
            ['name' => 'X-Men', 'slug' => 'x-men', 'id_license_parent' => 4],
            ['name' => 'Batman', 'slug' => 'batman', 'id_license_parent' => 5],
            ['name' => 'Superman', 'slug' => 'superman', 'id_license_parent' => 5],
