            ...
            "columns": [
                ...
                {"data": "slug"},
                {
                    ...
                    render : function(data) {
                        return `<a href="<?= base_url('/admin/userpermission/')?>${data}"><i class="fa-solid fa-pencil"></i></a>`;
                    }
                },
                {
                    data : 'id',
                    sortable : false,
                    render : function(data) {
                        return `<a href="<?= base_url('/admin/userpermission/delete/')?>${data}"><i class="fa-solid fa-trash"></i></a>`;
                    }
                }
            ]
        });
