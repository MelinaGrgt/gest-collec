        ...
        var dataTable = $('#tableUsers').DataTable({
            ...
            "columns": [
                ...
                {"data": "permission_name"},
                {
                    ...
                    sortable : false,
                    render : function(data) {
                        return `<a href="<?=base_url('/admin/user/')?>${data}"><i class="fa-solid fa-pencil"></i></a>`;
                    }
                },
                {
                    data : 'id',
                    ...
                    render : function(data, type, row) {
                        return (row.deleted_at === null ?
                            `<a title="Désactiver l'utilisateur" href="<?=base_url('/admin/user/deactivate/')?>${row.id}"><i class="fa-solid fa-xl fa-toggle-off text-success"></i></a>`: `<a title="Activer un utilisateur"href="<?=base_url('/admin/user/activate/')?>${row.id}"><i class="fa-solid fa-toggle-on fa-xl text-danger"></i></a>`);
                    }
                }
            ]
        });
