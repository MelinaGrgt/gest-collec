    ...
    <div class="col-md-9">
        <div class="card h-100">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col text-center" id="chargerPlus" data-limit="12" data-offset="0">
                        <div class="btn btn-outline-primary" id="btnChargerPlus">Charger plus de médias
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    $(document).ready(function(){
        ...
        $('#btnChargerPlus').on('click', function(e){
            ...
            console.log('entity_type: '+ entity_type + "| limite: " + limit + " | offset: " + offset);
            $.ajax ({
                type : "GET",
