    ...
    <div class="col">
        <div class="card">
            <div class="card-header">
                <h3>Gestion des Types d'objets</h3>
            </div>
        </div>
    </div>
</div>
<div class="row">
    ...
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                <table class="table table-sm table-hover table-striped" id="tableTypes">
                    <thead>
                    <tr>
                        <th>ID</th>
                        <th>Nom</th>
...
<script>
    $(document).ready(function () {
        var dataTable = $('#tableTypes').DataTable({
            ...
            "columns": [
                ...
                {"data": "slug"},
                {
                    ...
                    render : function(data) {
                        return `<a class="swal2-type" id="${data}" swal2-title="Êtes-vous sûr de vouloir supprimer ce type" swal2-text="" href="<?= base_url('/admin/item/deletetype/'); ?>${data}"><i class="fa-solid
            ...
            let id = $(this).attr("id");
            if (id == 1){
                Swal.fire('Impossible de supprimer "Aucun-Type"!');
            } else {
                $.ajax({
                    type: "GET" ,
                    url: "<?=base_url('/admin/item/totalitemtype');?>",
                    data: {
                        id: id,
                    },
