            ...
            "columns": [
                ...
                },
                {
                    ...
                    render : function(data) {
                        return `<a target="_blank" href="<?=base_url('/item/')?>${data}"><i class="fa-solid fa-eye"></i></a>`;
                    }
                },
                {
                    data : 'id',
                    sortable : false,
                    render : function(data) {
                        return `<a href="<?=base_url('/admin/item/')?>${data}"><i class="fa-solid fa-pencil"></i></a>`;
                    }
                },
                {
                    data : 'id',
                    sortable : false,
                    render : function(data) {
                        return `<a href="<?=base_url('/admin/item/deleteitem/')?>${data}"><i class="fa-solid fa-trash text-danger"></i></a>`;
                    }
                },
            ]
        });
