            ...
            "columns": [
                ...
                {"data": "name"},
                {
                    ...
                    render : function(data, type, row) {
                        return (row.active == 1 ?
                            `<a title="Désactiver" href="/admin/item/deactivate/${row.id}"><i class="fa-solid fa-xl
                            fa-toggle-on text-success"></i></a>`: `<a title="Activer"href="/admin/item/activate/${row.id}"><i class="fa-solid fa-toggle-off fa-xl text-danger"></i></a>`);
