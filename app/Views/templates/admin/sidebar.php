<div class="sidebar sidebar-dark sidebar-fixed border-end" id="sidebar">
    <div class="sidebar-header border-bottom">
        <div class="sidebar-brand">
            <img src="<?=base_url('/assets/brand/logo-blanc.svg')?>" class="sidebar-brand-full" width="88" height="32" alt="Gest-Collect" />
            <img src="<?=base_url('/assets/brand/logo-blanc.svg')?>" class="sidebar-brand-narrow" width="32" height="32" alt="Gest-Collect" />
            Gest-Collect
        </div>
