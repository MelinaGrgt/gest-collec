<div class="row">
    <div class="col-md-3">
        <div class="card h-100">
            ...
            <div class="card-body">
                <form method="get" action="<?= base_url('collection'); ?>">
        ...
        <div class="card h-100">
            ...
            <div class="card-body">
                <?php foreach(array_chunk($items, 4) as $chunk) : // Diviser les éléments en groupes de 4 ?>
                    <div class="row row-cols-md-4 shelf-row px-4 ">
                            ...
                            <div class="col">
                                <div class="card h-100">
                                    ...
                                    <div class="card-footer text-center">
                                        <a href="<?= base_url("/collection/deletecollection/" . $item['id']) ?>" class="btn
                                            btn-danger btn-sm" title="Enlever de ma collection"><i class="fa-solid
                                            fa-plus fa-lg"></i> Supprimer de ma collection</a>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; ?>
...
<!--Affichage du bouton pour les données-->
<!-- START: OFFCANVAS -->
